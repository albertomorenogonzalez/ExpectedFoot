...
def compile_stats(games, goals, assists, pens_att, pens_made, progressive_carries):  
    ...
    predictions = st.session_state["prediction_list"].append((st.session_state["jugador"], str(round(prediction[0],2))))
...
with st.sidebar:
    ...
    predictions = st.write(st.session_state["prediction_list"])
